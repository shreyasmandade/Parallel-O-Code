...
export default function Blurring() {
    ...
    <div className="algo-content">
        ...
        <div className="gif-here">
            <img alt="blurring" src="/gif/blurr/micky.gif"></img>
            <img alt="blurring" src="/gif/blurr/bigben.gif"></img>
            <img alt="blurring" src="/gif/blurr/house.gif"></img>
            <img alt="blurring" src="/gif/blurr/spidey.gif"></img>
            <img alt="blurring" src="/gif/blurr/angry.gif"></img>
        </div>
        </section>  
        ...
        <div className="source-result">
            <img alt="blurring" src="/gif/blurr/graph.PNG"></img>
        </div>
        </section>  
    </div>
